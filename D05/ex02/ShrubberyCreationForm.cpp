...
//constructors
ShruberryCreationForm::ShruberryCreationForm(std::string target) : Form(target, 145, 137)
{
	return;
}

ShruberryCreationForm::ShruberryCreationForm(ShruberryCreationForm &copy) : Form(copy.getName(), 145, 137)
{
	*this = copy;
	return;
}
...
//actions
void			ShruberryCreationForm::execute(Bureaucrat const &wants_to_execute) const
{
